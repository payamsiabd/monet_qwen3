...
import torch
from monet_qwen_model import apply_qwen3_vl_monet
from transformers import Qwen3VLForConditionalGeneration, Qwen3VLConfig, AutoTokenizer, AutoProcessor
...
# The five special tokens added above may exceed the base checkpoint's vocab
# size (Qwen2.5-VL's tokenizer has enough reserved/unused slots to not need
# this, Qwen3-VL's may not); resize is a no-op when the tokenizer already fits.
